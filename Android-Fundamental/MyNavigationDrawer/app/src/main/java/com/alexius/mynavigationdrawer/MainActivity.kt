package com.alexius.mynavigationdrawer
...
import com.alexius.mynavigationdrawer.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var profileCircleImagwView: CircleImageView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        profileCircleImagwView = navView.getHeaderView(0).findViewById(R.id.imageView)
        Glide.with(this)
            .load(profileImageUrl)
            .into(profileCircleImagwView)
