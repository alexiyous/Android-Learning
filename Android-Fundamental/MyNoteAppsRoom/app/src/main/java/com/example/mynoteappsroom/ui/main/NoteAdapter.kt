...
class NoteAdapter : RecyclerView.Adapter<NoteAdapter.NoteViewHolder>() {
    ...
    //  NoteDiffCallback untuk memeriksa perubahan yang ada pada listNotes. Jadi jika ada perubahan pada listNotes,
    //  maka akan memperbarui secara otomatis. NoteDiffCallback digunakan sebagai pengganti notifyDataSetChanged,
