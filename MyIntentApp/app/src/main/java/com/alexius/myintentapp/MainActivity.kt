    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.btn_move_activity_data -> {
                ...
                moveWithDataIntent.putExtra(MoveWithActivityData.EXTRA_NAME, "DicodingAcademy Boy")
                moveWithDataIntent.putExtra(MoveWithActivityData.EXTRA_AGE, 5)
