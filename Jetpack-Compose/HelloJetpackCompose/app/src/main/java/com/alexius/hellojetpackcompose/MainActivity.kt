package com.alexius.hellojetpackcompose
...
import com.alexius.hellojetpackcompose.ui.theme.HelloJetpackComposeTheme
...
@Composable
fun HelloJetpackComposeApp(modifier: Modifier = Modifier) {
    Surface(
...
@Composable
fun GreetingList(modifier: Modifier = Modifier, names: List<String>) {
    if (names.isNotEmpty()) {
        LazyColumn {
            items(names) { name ->
                Greeting(name = name)
